...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineBoundsWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 1, 14, 5, 5);
			...
			Utils.RegisterLazyFunc(L, Utils.METHOD_IDX, "<>xLuaBaseProxy_GetHashCode", type, LazyMemberTypes.Method, false);
            Utils.RegisterLazyFunc(L, Utils.METHOD_IDX, "<>xLuaBaseProxy_Equals", type, LazyMemberTypes.Method, false);
